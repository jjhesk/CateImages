...
function z_add_texonomy_field()
{
    ...
    echo '<div class="form-field">
		...
		<input type="text" placeholder="image 1 (unpress)" name="taxonomy_image" id="taxonomy_image" value="" />
		<input type="text" placeholder="image 2 (press)" name="taxonomy_image_2" id="taxonomy_image_2" value="" />
		<input type="text" placeholder="image 3 (unpress_s)" name="taxonomy_image_3" id="taxonomy_image_3" value="" />
		<input type="text" placeholder="image 4 (press_s)" name="taxonomy_image_4" id="taxonomy_image_4" value="" />
		<br/>
		<button class="z_upload_image_button button">' . __('Upload/Add image', 'zci') . '</button>
	</div>' . z_script("taxonomy_image");
}
